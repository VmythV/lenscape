...
mixin _$Favorite {
 ...
 String get poseId; int get createdAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Favorite&&(identical(other.poseId, poseId) || other.poseId == poseId)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,poseId,createdAt);

@override
String toString() {
  return 'Favorite(poseId: $poseId, createdAt: $createdAt)';
}
...
/// Create a copy of Favorite
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? poseId = null,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String poseId,  int createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Favorite() when $default != null:
return $default(_that.poseId,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String poseId,  int createdAt)  $default,) {final _that = this;
switch (_that) {
case _Favorite():
return $default(_that.poseId,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String poseId,  int createdAt)?  $default,) {final _that = this;
switch (_that) {
case _Favorite() when $default != null:
return $default(_that.poseId,_that.createdAt);case _:
  return null;
...
class _Favorite implements Favorite {
  const _Favorite({required this.poseId, required this.createdAt});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Favorite&&(identical(other.poseId, poseId) || other.poseId == poseId)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}
...
/// Create a copy of Favorite
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? poseId = null,Object? createdAt = null,}) {
